...
#======================= For Urban loacation  ======================
#==== Beijing ====================================
ax[0,0].scatter(aero.date,aero.Beijing, color='darkgray' ,label='AERONET',s=0.3)
ax[0,0].plot(wrf.date,wrf.Beijing,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[0,0].plot(cams.date,cams.Beijing, color='coral' ,label='CAMS',linewidth=0.3)
ax[0,0].plot(merra.date,merra.Beijing,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[0,0].set_ylabel('Beijing',fontsize=5)
#==== Dhaka  ====================================
ax[1,0].scatter(aero.date,aero.Dhaka, color='darkgray' ,label='AERONET',s=0.3)
ax[1,0].plot(wrf.date,wrf.Dhaka,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[1,0].plot(cams.date,cams.Dhaka, color='coral' ,label='CAMS',linewidth=0.3)
ax[1,0].plot(merra.date,merra.Dhaka,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[1,0].set_ylabel('Dhaka',fontsize=5)
#==== Kanpur ====================================
ax[2,0].scatter(aero.date,aero.Kanpur, color='darkgray' ,label='AERONET',s=0.3)
ax[2,0].plot(wrf.date,wrf.Kanpur,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[2,0].plot(cams.date,cams.Kanpur, color='coral' ,label='CAMS',linewidth=0.3)
ax[2,0].plot(merra.date,merra.Kanpur,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[2,0].set_ylabel('Kanpur',fontsize=5)
#==== Lumbini ====================================
ax[3,0].scatter(aero_lumbini.date,aero_lumbini.Lumbini, color='darkgray' ,label='AERONET',s=0.3)
ax[3,0].plot(wrf.date,wrf.Lumbini,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[3,0].plot(cams.date,cams.Lumbini, color='coral' ,label='CAMS',linewidth=0.3)
ax[3,0].plot(merra.date,merra.Lumbini,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[3,0].set_ylabel('Lumbini',fontsize=5)
#==== Karachi ====================================
ax[4,0].scatter(aero_karachi.date,aero_karachi.Karachi, color='darkgray' ,label='AERONET',s=0.3)
ax[4,0].plot(wrf.date,wrf.Karachi,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[4,0].plot(cams.date,cams.Karachi, color='coral' ,label='CAMS',linewidth=0.3)
ax[4,0].plot(merra.date,merra.Karachi,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[4,0].set_ylabel('Karachi',fontsize=5)
#============================= For Remote locations =======================
#==== Langtang ====================================
ax[0,1].scatter(aero_langtang.date,aero_langtang.Langtang, color='darkgray' ,label='AERONET',s=0.3)
ax[0,1].plot(wrf.date,wrf.Langtang,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[0,1].plot(cams.date,cams.Langtang, color='coral' ,label='CAMS',linewidth=0.3)
ax[0,1].plot(merra.date,merra.Langtang,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[0,1].set_ylabel('Langtang',fontsize=5)
#==== QOMS  ====================================
ax[1,1].scatter(aero_qoms.date,aero_qoms.qoms, color='darkgray' ,label='AERONET',s=0.3)
ax[1,1].plot(wrf.date,wrf.Qoms,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[1,1].plot(cams.date,cams.Qoms, color='coral' ,label='CAMS',linewidth=0.3)
ax[1,1].plot(merra.date,merra.Qoms,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[1,1].set_ylabel('Qoms',fontsize=5)
#==== Namco ====================================
ax[2,1].scatter(aero_namco.date,aero_namco.Namco, color='darkgray' ,label='AERONET',s=0.3)
ax[2,1].plot(wrf.date,wrf.Namco,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[2,1].plot(cams.date,cams.Namco, color='coral' ,label='CAMS',linewidth=0.3)
ax[2,1].plot(merra.date,merra.Namco,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[2,1].set_ylabel('Namco',fontsize=5)
#==== Mezaira ====================================
ax[3,1].scatter(aero.date,aero.Mezaira, color='darkgray' ,label='AERONET',s=0.3)
ax[3,1].plot(wrf.date,wrf.Mezaira,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[3,1].plot(cams.date,cams.Mezaira, color='coral' ,label='CAMS',linewidth=0.3)
ax[3,1].plot(merra.date,merra.Mezaira,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
ax[3,1].set_ylabel('Mezaira',fontsize=5)
#==== Dushambe ====================================
ax[4,1].scatter(aero_dushambe.date,aero_dushambe.Dushambe, color='darkgray' ,label='AERONET',s=0.3)
ax[4,1].plot(wrf.date,wrf.Dushambe,  color='palevioletred' ,label='WRF-Chem',linewidth=0.3,linestyle='dotted')
ax[4,1].plot(cams.date,cams.Dushambe, color='coral' ,label='CAMS',linewidth=0.3)
ax[4,1].plot(merra.date,merra.Dushambe,  color='darkcyan' ,label='MERRA-2',linewidth=0.3)
...
## Saving the plot
#plt.savefig('/mnt/g/2nd_paper/aod_1000dpi.png',dpi=1000)
